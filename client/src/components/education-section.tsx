          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="md:pl-16 text-center">
                <div className="w-40 h-40 rounded-full border-4 border-primary-500 mx-auto shadow-lg shadow-primary-500/20 overflow-hidden bg-white flex items-center justify-center">
                  <img
                    src={logo67}
